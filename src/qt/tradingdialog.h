...
private slots:
    ...
    QString BuySQR(QString OrderType, double Quantity, double Rate);
    QString SellSQR(QString OrderType, double Quantity, double Rate);
